...
export default function Goals() {
  ...
  const applyGoalCompletion = (goal) => {
    ...
    const map = {
      ...
      savings:          () => addRecords('finance', [{ date: now, amount: targetValue, category: 'savings',     transactionType: 'credit', description: 'Goal achieved' }]),
      investments:      () => addRecords('finance', [{ date: now, amount: targetValue, category: 'investments', transactionType: 'credit', description: 'Goal achieved' }]),
      expenses:         () => addRecords('finance', [{ date: now, amount: targetValue, category: 'others',      transactionType: 'debit',  description: 'Goal achieved' }]),
      income:           () => addRecords('finance', [{ date: now, amount: targetValue, category: 'income',      transactionType: 'credit', description: 'Goal achieved' }]),
