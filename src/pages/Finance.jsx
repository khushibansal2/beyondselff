...
export default function Finance() {
  ...
  return (
    <div className={`page-container min-h-screen pb-2 ${['log'].includes(tab) ? '' : 'bg-mesh'}`} style={['log'].includes(tab) ? { backgroundColor: '#090a0f', fontFamily: 'var(--font-primary)' } : { fontFamily: 'var(--font-primary)' }}>
